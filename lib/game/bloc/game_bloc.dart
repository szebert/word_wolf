    ...
    _analyticsBloc.add(
      TrackAnalyticsEvent(
        GameStartedEvent(
          ...
          wordPairSimilarity: state.game.wordPairSimilarity,
          wordGeneration: isOnline ? "online" : "offline",
          // game settings
          categoryEnabled:
              _categoryBloc.state.selectedCategory.isNotEmpty ? "yes" : "no",
          discussionTimeInSeconds: state.game.discussionTimeInSeconds,
          playerCount: playerCount,
          wolfCount: wolfCount,
          randomizeWolfCount: state.game.randomizeWolfCount ? "yes" : "no",
          autoAssignWolves: state.game.autoAssignWolves ? "yes" : "no",
          wolfRevengeEnabled: state.game.wolfRevengeEnabled ? "yes" : "no",
        ),
      ),
    );
